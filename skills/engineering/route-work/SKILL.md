...
Do not route a reported failure directly to implementation while its root cause remains unconfirmed. Do not route an unconfirmed inference to `$maintain-context` or `$to-adr`.
